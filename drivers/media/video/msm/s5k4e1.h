...
struct s5k4e1_reg {
	...
	const struct s5k4e1_i2c_reg_conf *rec_record_settings;
	const unsigned short rec_record_settings_size;
	...
	const struct s5k4e1_i2c_reg_conf *reg_record;
	const unsigned short reg_record_size;
